 ...
 *
 *
 *  * 这个是实现Comparable接口来进行排序的，然后就可以放在集合中用sort调用排序了，对于所有的x 和 y 满足-1 0 1来比较他们的大小。x.compareTo(y)和y.compareTo(x)符号相反。同时会抛出异常。并且比较能够传递。对于(x.compareTo(z)==0)==(y.compareTo(z))
 */
